...
func bybitSubscribe(symbols []exchanges.Symbol, tickers map[string]*bybitTicker, withFunding bool) func(*websocket.Conn) error {
...
func ConnectFutures(source string, symbols []exchanges.Symbol, f exchanges.Feeds) {
	exchanges.RunStream(f, bybitStream(source, symbols, f, "wss://stream.bybit.com/v5/public/linear", true))
}
...
func ConnectSpot(source string, symbols []exchanges.Symbol, f exchanges.Feeds) {
	exchanges.RunStream(f, bybitStream(source, symbols, f, "wss://stream.bybit.com/v5/public/spot", false))
}
...
func bybitStream(source string, symbols []exchanges.Symbol, f exchanges.Feeds, url string, withFunding bool) exchanges.StreamConfig {
...
func handleBybitFrame(source string, symbols []exchanges.Symbol, tickers map[string]*bybitTicker, f exchanges.Feeds, raw []byte, recvAt time.Time) {
