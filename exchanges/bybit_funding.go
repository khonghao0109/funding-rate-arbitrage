...
func normalizeBybitFunding(in bybitFundingInput) (FundingData, error) {
	if in.IntervalHours <= 0 {
		return FundingData{}, fmt.Errorf("bybit funding %s: non-positive interval %dh", in.Symbol, in.IntervalHours)
	}
