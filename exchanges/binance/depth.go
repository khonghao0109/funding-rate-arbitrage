...
// FetchFuturesDepth reads the USDⓈ-M futures book.
...
func fetchBinanceDepth(ctx context.Context, endpoint, source string, symbol exchanges.Symbol, levels int) (exchanges.DepthBook, error) {
...
func parseBinanceDepth(resp binanceDepthResponse, source string, symbol exchanges.Symbol) (exchanges.DepthBook, error) {
	book := exchanges.DepthBook{Symbol: symbol.Standard, Source: source, VenueTimeMs: resp.EventTimeMs}
	var err error
