...
// already turns into errInstrumentNotListed (measured at step 2.4, where one
...
// FetchParadexDepth reads one perpetual book.
func FetchParadexDepth(ctx context.Context, source string, symbol Symbol, levels int) (DepthBook, error) {
...
func parseParadexDepth(resp paradexDepthResponse, source string, symbol Symbol) (DepthBook, error) {
	book := DepthBook{Symbol: symbol.Standard, Source: source, VenueTimeMs: resp.LastUpdatedAt}
	var err error
