...
├── cmd/brokercheck/           # chẩn đoán 4.1: REST có ký trên TESTNET, không đặt lệnh
...
│   ├── broker/                # ⚠️ package DUY NHẤT giữ credential — 4.1, CHỈ testnet
